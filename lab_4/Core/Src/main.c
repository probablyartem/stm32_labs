...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
static SystemMode_t currentMode = MODE_TEST;
static uint8_t lastButtonState = 0;
static uint32_t lastModeToggleTime = 0;  // для антидребезга боковой кнопки
#define MODE_DEBOUNCE_MS  100
/* USER CODE END PD */
